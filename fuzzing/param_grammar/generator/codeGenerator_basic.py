...
from .generator_utils import build_statement_from_raw_call, replace_statement_parameter, remove_braces
        ...
        while generated_count < count:
            ...
            if random.random() < 0.5:
                ...
                #     self.tmp_object_list.add(first_return_value)
                    ...
                    # if first_return_type in self.object_generators.keys():
            ...
            # Attempt to pick a related API with 50% chance if weak_relation is True
            if weak_relation and random.random() < 0.5:
            ...
            # 3) If symbolic_relation is True, with a 50% chance attempt a symbolic relation
            #    between the first and second API calls.
            second_raw_call = None
            if symbolic_relation and random.random() < 0.5:
